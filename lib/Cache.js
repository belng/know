...
module.exports = class Cache {
	...
	*/
	...
	deleteEntity(id) {
		console.log("delete: ", id, this.entities[id], this._types);
		let keyValues = this.getKeyValues(this.entities[id]);
		console.log(keyValues);
		for (let key in keyValues) {
			this.indexes[key].delete(keyValues[key]);
		}
	...
	putIndex(key, knowledge, items) {
		...
		console.log("second log inside putIndex");
		...
		console.log("third log inside putIndex");
		...
		console.log("fourth log inside putIndex");
	}
	...
	*/
	put(changes) {
		...
		if (changes.knowledge) { for (let key in changes.knowledge) {
			...
			console.log("calling putIndex");
			this.putIndex(key, changes.knowledge[key], items);
		}}
		
		console.log("after putIndex");
		/* handle the addition of individual entities */
		if (changes.entities) { for (let id in changes.entities) {
			if (changes.entities[id] === null) this.deleteEntity(id);
			else this.putEntity(changes.entities[id]);
		}}
		...
		console.log("second after putIndex");
