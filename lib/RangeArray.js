...
class Range {
	constructor(args) {
		...
		if (args.end) this.end = args.end;
		if (args.before) this.before = args.before;
		if (args.after) this.after = args.after;
		...
		Object.defineProperty(this, '1', {
			get: () => this.end || this.before,
			set: (value) => this[this.length === 3 ? 'before' : 'after'] = value
		});
