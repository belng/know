...
const decorate = (arr, prop, index) => Object.defineProperty(
		arr, prop, { get: () => arr[index], set: (v) => arr[index] = v, configurable: true}
	),
...
class RangeArray {
	...
	*/
	...
	difference(ranges) {
		...
		if (b.arr.length === 0) { console.log("HERE", this, new RangeArray(this)); return new RangeArray(this); }
